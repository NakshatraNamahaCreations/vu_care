...
export default function Layout() {
  ...
  const commercial = [
    ...
    { title: "", img: "../NewImg/cmrs (4).png" },
    { title: "", img: "../NewImg/cmrs (5).png" },
    { title: "", img: "../NewImg/cmrs (6).png" },
    { title: "", img: "../NewImg/cmrs (7).png" },
    { title: "", img: "../NewImg/cmrs (8).png" },
    { title: "", img: "../NewImg/cmrs (9).png" },
    { title: "", img: "../NewImg/cmrs (10).png" },
    { title: "", img: "../NewImg/cmrs (11).png" },
    { title: "", img: "../NewImg/cmrs (12).png" },
  ];
              ...
              <div className="row m-auto mt-3 text-center">
                {commercial.map((ele) => (
                  <div className="col-md-2 m-auto mt-4">
                    ...
                    <div className="row m-auto  fnt14  mt-2   boldt">
                      <span className=" m-auto">{ele?.title}</span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="row m-auto mt-3">
                {Clients.map((ele) => (
                  <img
                    src={ele}
                    height={100}
                    className="col-md-2 m-auto ourClients"
                  />
                ))}
              </div>
            </div> */}
